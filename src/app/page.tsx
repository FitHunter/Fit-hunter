    ...
    <div className="flex flex-col">
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold text-center text-gray-900 mb-10">Why NextFit?</h2>
      ...
      <footer className="bg-gray-900 text-gray-400 py-10 px-4 text-sm">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-gray-500">© {new Date().getFullYear()} NextFit. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
